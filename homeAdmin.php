...
while ($row = mysqli_fetch_assoc($defaultResult)) {
    $defaultStudentList .= "<tr>
        ...
        <td>
            <a href='timeline-admin.php?nama=" . urlencode($row['nama']) . "' class='btn btn-primary timeline-btn'>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function filterData(school, periode) {
                ...
                $.ajax({
                    url: 'filter_students.php', // Buat file baru untuk handle filter
                    type: 'POST',
                    data: {
                        school: school,
                        periode: periode
        ...
        // Tambah code untuk handle loading
